...
mac = get_mac()
mac = "".join(c + ":" if i % 2 else c for i, c in enumerate(hex(mac)[2:].zfill(12)))[:-1]
...
sensors = ["/sensors/airtemp", "/sensors/watertemp", "/sensors/lightstr", "/sensors/airhumidity", "/sensors/waterph"]
